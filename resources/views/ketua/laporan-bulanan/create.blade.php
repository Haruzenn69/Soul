...
@section('content')
    <div class="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm max-w-2xl">
        <form action="{{ route('ketua.laporan-bulanan.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-4">
                <label class="block text-xs font-bold text-gray-500 mb-1">Dokumentasi (Gambar)</label>
