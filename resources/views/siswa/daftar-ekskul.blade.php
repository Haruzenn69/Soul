    ...
    <div class="flex-1 flex flex-col min-w-0">
        ...
        <main class="p-4 md:p-8 space-y-6 overflow-y-auto">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 animate-fade-up">
                <div>
                    <h1 class="text-xl font-extrabold text-slate-900">Daftar Ekskul</h1>
                    <p class="text-xs text-slate-400 mt-0.5">Pilih ekskul yang ingin kamu ikuti</p>
                </div>
                <a href="{{ route('siswa.katalog') }}" class="px-4 py-2 bg-white hover:bg-sky-50 text-slate-600 text-xs font-semibold rounded-lg border border-sky-100 shadow-sm transition flex items-center gap-2">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Daftar Ekskul yang Tersedia -->
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                @forelse($ekskuls as $ekskul)
                <div class="bg-white p-5 rounded-2xl border border-sky-100 shadow-sm hover:shadow-lg hover:-translate-y-1 hover:border-sky-200 transition-all duration-300">
                    <div class="flex items-center gap-3 mb-3">
                        <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-sky-400 to-blue-500 text-white font-bold flex items-center justify-center text-sm shadow-lg shadow-sky-200 uppercase">
                    ...
                    @if($ekskul->is_open_recruitment)
                        ...
                        <!-- Tombol Daftar Sekarang (redirect ke form) -->
