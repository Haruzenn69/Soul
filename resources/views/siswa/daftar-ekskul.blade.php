    ...
    <div class="flex-1 flex flex-col min-w-0">
        ...
        <main class="p-8 space-y-6 overflow-y-auto">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    <h1 class="text-xl font-bold text-slate-900">Daftar Ekskul</h1>
                    <p class="text-xs text-slate-400 mt-0.5">Pilih ekskul yang ingin kamu ikuti</p>
                </div>
                <a href="{{ route('siswa.katalog') }}" class="px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-600 text-xs font-semibold rounded-lg transition flex items-center gap-2">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-blue-50 p-4 rounded-2xl border border-blue-200 flex items-start gap-3">
                ...
                <div>
                    <p class="text-xs text-blue-700">Kamu hanya bisa mendaftar ke <span class="font-semibold">1 ekskul</span> dalam satu periode. Pilih dengan baik sesuai minat dan bakatmu.</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                ...
                <div class="bg-white p-5 rounded-2xl border border-slate-200/70 shadow-sm hover:shadow-md transition">
                    ...
                    @if($ekskul->is_open_recruitment)
                        ...
                        <a href="{{ route('siswa.form-daftar', $ekskul->id) }}" class="block w-full py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold rounded-lg transition shadow-sm text-center">
                            Daftar Sekarang
                        </a>
                    @else
                        <div class="flex items-center justify-between mb-3">
                        ...
                        <button class="w-full py-2.5 bg-slate-200 text-slate-400 text-xs font-semibold rounded-lg cursor-not-allowed" disabled>
                            Tidak Tersedia
                        </button>
                    @endif
                </div>
