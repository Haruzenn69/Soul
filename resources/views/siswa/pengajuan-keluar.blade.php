    ...
    <div class="flex-1 flex flex-col min-w-0">
        ...
        <main class="p-4 md:p-8 space-y-6 overflow-y-auto">
            ...
            <div class="animate-fade-up">
                <h1 class="text-xl font-extrabold text-slate-900">Pengajuan Keluar</h1>
                <p class="text-xs text-slate-400 mt-0.5">Ajukan permohonan keluar dari ekskul yang sedang diikuti</p>
            </div>

            <!-- Form Pengajuan -->
            <div class="bg-white p-6 rounded-2xl border border-sky-100 shadow-sm animate-fade-up" style="animation-delay: .1s">
                ...
                @if($ekskul)
                    <div class="mb-4 p-4 bg-gradient-to-r from-sky-50 to-blue-50 rounded-xl border border-sky-200 flex items-center gap-3">
                        <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-sky-400 to-blue-500 text-white flex items-center justify-center text-xs font-extrabold uppercase shadow-md shadow-sky-200">
                    ...
                    <form action="{{ route('siswa.pengajuan-keluar.store') }}" method="POST">
                        ...
                        <div class="space-y-4">
                            <div>
                                <label class="text-xs font-semibold text-slate-700 block mb-1">Alasan Keluar <span class="text-red-500">*</span> <span class="text-red-500 font-medium normal-case">(wajib diisi)</span></label>
            ...
            <div class="bg-white p-6 rounded-2xl border border-sky-100 shadow-sm animate-fade-up" style="animation-delay: .2s">
                <h2 class="text-sm font-bold text-slate-900 mb-4">Riwayat Pengajuan</h2>
                <div class="space-y-3">
                    @foreach($pengajuan as $item)
                    <div class="p-4 bg-gradient-to-r from-sky-50 to-amber-50 rounded-xl border border-sky-100 flex items-center justify-between">
                        <div>
