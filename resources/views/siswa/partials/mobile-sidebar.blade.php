...
<div id="sidebar-mobile" class="hidden fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-slate-200/80 flex flex-col justify-between p-5 md:hidden shadow-xl">
    <div class="overflow-y-auto">
        ...
        <nav class="space-y-1">
            <a href="{{ route('siswa.dashboard') }}" class="flex items-center gap-3 px-3.5 py-2.5 {{ request()->routeIs('siswa.dashboard') ? 'bg-blue-50 text-blue-600 rounded-xl font-semibold' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900 rounded-xl font-medium' }} text-xs transition-colors">
            ...
            <a href="{{ route('siswa.katalog') }}" class="flex items-center gap-3 px-3.5 py-2.5 {{ request()->routeIs('siswa.katalog') ? 'bg-blue-50 text-blue-600 rounded-xl font-semibold' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900 rounded-xl font-medium' }} text-xs transition-colors">
                <span class="text-base flex items-center justify-center w-4 h-4">
            ...
            <a href="{{ route('siswa.presensi') }}" class="flex items-center gap-3 px-3.5 py-2.5 {{ request()->routeIs('siswa.presensi') ? 'bg-blue-50 text-blue-600 rounded-xl font-semibold' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900 rounded-xl font-medium' }} text-xs transition-colors">
                <span class="text-base flex items-center justify-center w-4 h-4">
