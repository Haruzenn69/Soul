...
<body class="bg-gradient-to-br from-sky-50 via-white to-amber-50 text-slate-800 font-sans antialiased min-h-screen md:flex overflow-x-hidden">@include('partials.pill-sidebar', [
    ...
    <div class="w-full flex-1 flex flex-col min-w-0 ps-page">
        ...
        <main class="p-4 md:p-8 space-y-5 md:space-y-6">
            ...
            <div class="bg-gradient-to-r from-sky-400 to-blue-500 p-4 md:p-5 rounded-2xl shadow-lg shadow-sky-200 text-white flex items-center gap-3 animate-fade-up" style="animation-delay: .05s">
                ...
                <form method="POST" action="{{ route('siswa.daftar-ekskul.store') }}">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <p class="text-[10px] text-slate-400 mt-1.5 leading-relaxed">Wajib diisi. Tulis alasan yang jelas (minimal 10 karakter / 2 kata) Ã¢â‚¬â€ alasan seperti "asd", "gatau", atau "malas" tidak diterima.</p>
                            @error('alasan')
